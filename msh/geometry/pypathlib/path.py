...
class Path:
    ...
    def _all_distances(self, x):
        ...
        if self.points.shape[0] == 1:
            # В случае, если есть только одна точка, т.е. без сторон.
        ...
        # Найти ближайшую точку для каждого бокового сегмента
        ...
        # t-параметр для каждой стороны, минимальный квадрат расстояния и индекс ближайшей стороны
